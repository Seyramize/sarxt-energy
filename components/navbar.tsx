...
// Navigation array for Ghana solar energy services
const navigation = [
  { name: "Home", href: "/" },
  { name: "About", href: "/about" },
  { name: "Services", href: "/services" },
  { name: "Solar Packages", href: "/solar-packages" },
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">SeyEnergy</span>
            <div className="flex items-center">
              <Image src="/logo.png" alt="SeyEnergy Logo" width={40} height={40} className="h-10 w-auto" />
              <span className="ml-2 text-xl font-bold text-sarxt-dark dark:text-white">SeyEnergy</span>
            </div>
          </Link>
        </div>
