    ...
    <div className="bg-white py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose max-w-none">
          ...
          <p>
            By accessing or using the Sey Energy website and services, you agree to be bound by these Terms of Service
          ...
          <p>
            Sey Energy provides solar energy solutions and M.E.P. (Mechanical, Electrical, and Plumbing) services for
          ...
          <p>
            To the fullest extent permitted by law, Sey Energy shall not be liable for any indirect, incidental,
          ...
          <p>
            You agree to indemnify and hold harmless Sey Energy and its officers, directors, employees, and agents
